...
<div id="root">
	...
	<div class="login_container">
        ...
        <div class="login-box">
            ...
            <input type="text" name="id" id="id" maxlength="30" autocapitalize="off">
        ...
        <div class="forget">
            <label for=""><input type="checkbox" class="checkbox_input">ID저장</label>
        </div>
        <button id="login_button" type="submit" value="login">로그인</button>
    </form>
    <a href="#" class="forget_password">비밀번호를 잊어버리셨나요?</a>
    <div class="login_signup">
        <p>DLC.FRIENDS가 처음이신가요? <a href="signup.html">회원가입</a></p>
    </div>
    </div>
    </section>
